...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('bonsai/css/styleSanPhamChiTiet.css')}}">
            ...
            <div class="container">
                <div class="row menu-header">
                    ...
                    <div class="col-sm-1 col-lg-1 col-1 f-img">
                        <a href="https://www.facebook.com/Buoidienchinhhieu.vn" target="_blank">
                            <img src="{{ asset('bonsai/images/f.png') }}">
                        </a>
                    </div>
                    <div class="col-sm-1 col-lg-1 col-1 t-img">
                        <a href="https://twitter.com/caycanhonline" target="_blank">
        ...
        <div class="e-footer">
            <div class="row footer-container">
                ...
                <div class="col bt-footer">
                    ...
                    <br/>
                    <i class="fas fa-map-marker-alt"> </i> Địa chỉ: Đường Phú Minh, Văn Trì, Minh Khai, Bắc Từ Liêm, Hà Nội
                    <br/>
                    <i class="fas fa-phone-alt"> </i> Hotline: 093 6596 425 (Mrs.Thủy) - 0976885796 (Mr.Lâm)
                    <br/>
                    <i class="far fa-envelope"> </i> Email: buoidienvn@gmail.com
                    <br/>
                    <i class="fas fa-globe-africa"> </i> Website: buoidienvn
                    <br/>
